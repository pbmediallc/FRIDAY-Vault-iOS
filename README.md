> **F.R.I.D.A.Y. Vault iOS** is a modified, independently maintained fork of the
> Bitwarden iOS Password Manager. It is not affiliated with or endorsed by
> Bitwarden, Inc. PB Media LLC began modifying this GPLv3 work on 19 August
> 2026. The upstream source, GPLv3 obligations, security boundaries, and
> modification baseline are documented in
...
> `1.0.1 (2026081901)` build is recorded at
> [`v1.0.1-2026081901`](https://github.com/pbmediallc/FRIDAY-Vault-iOS/tree/v1.0.1-2026081901).
