...
class BitwardenDeepLinkConstantsTests: BitwardenTestCase {
    ...
    func test_accountSecurity_value() {
        XCTAssertEqual(BitwardenDeepLinkConstants.accountSecurity, "fridayvault://settings/account_security")
    }

    /// `authenticatorNewItem` has the expected deep link value.
    func test_authenticatorNewItem_value() {
        XCTAssertEqual(BitwardenDeepLinkConstants.authenticatorNewItem, "fridayvault://authenticator/newItem")
    }
